...
<jsp:useBean id="sampleTestWebProxyid" scope="session" class="ft.tt.testing.TestWebProxy" />
<%
...
case 10:
        gotMethod = true;
        ft.tt.testing.TestWeb getTestWeb10mtemp = sampleTestWebProxyid.getTestWeb();
...
case 13:
        ...
        java.lang.String sayHello13mtemp = sampleTestWebProxyid.sayHello(name_1idTemp);
